...
class MySQLConnection(object):
    ...
    def query_db(self, query, data=None):
        ...
        if query[0:6].lower() == 'select': 
            ...
            return result.lastrowid # to see the id of last registered user in case with reg form. you can throw this value to session to track the actions of this user.
        else:
